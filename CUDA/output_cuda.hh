#ifndef LBM_OUTPUT_CUDA_HH
#define LBM_OUTPUT_CUDA_HH
...
public:
     ...
     */
    XDMFWriter_CUDA(const std::string & prefix, std::size_t nx, std::size_t ny);
